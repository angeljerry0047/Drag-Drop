...
class List extends Component {
  state = {
    ...
    items: [
      ...
      [
        {id: Math.random(), type: 'component', value: 'Component9', x: 0, y: Infinity, w: 1, h: 2, add: false},
        {id: Math.random(), type: 'component', value: 'Component1', x: 1, y: Infinity, w: 1, h: 2, add: false},
        {id: Math.random(), type: 'component', value: 'Component2', x: 2, y: Infinity, w: 1, h: 2, add: false},
        ],
      [
